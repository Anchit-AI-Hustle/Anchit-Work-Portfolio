...
Now, at Vahdam India, since the twentieth of April twenty twenty six. I'm AGM, Product Management, D to C Growth, across the US, UK and global, still early in the role. My headline project is a customer lifecycle and retention O.S., a retention workflow that connects analytics, lifecycle planning, segmentation and mailer generation into one system. On the side I also built the All in One LP Agent, a D to C landing page with one embedded agent that narrates the page, talks back by voice, answers chat, and recommends products. And Mailer Architect, a universal multi LLM email generator that writes send ready mailers for any context, a brand, a school, an office, an event, a reminder, not just marketing. UK marketing revenue also went up early on. If ratings come up, that's a supporting contribution, not the headline.
